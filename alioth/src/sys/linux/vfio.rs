...
// #[derive(Debug, Clone)]
// #[repr(C)]
// pub struct VfioDeviceFeatureDmaBuf<const N: usize = 1> {
...
#[derive(Debug, Clone, FromBytes, IntoBytes, KnownLayout, Immutable)]
#[repr(C)]
pub struct VfioDeviceFeatureDmaBuf {
    pub region_index: u32,
    pub open_flags: u32,
    pub flags: u32,
    pub nr_ranges: u32,
    pub dma_range: VfioRegionDmaRange,
}
...
#[repr(C)]
#[derive(Debug, Clone)]
pub struct VfioDeviceFeature<const N: usize> {
    pub argsz: u32,
