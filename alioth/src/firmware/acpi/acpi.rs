...
pub fn create_fadt(dsdt_addr: u64) -> AcpiTableFadt {
    AcpiTableFadt {
        ...
        xpm_timer_block: AcpiGenericAddress {
            ...
            bit_width: 32,
            bit_offset: 0,
            access_width: 3, // https://uefi.org/htmlspecs/ACPI_Spec_6_4_html/05_ACPI_Software_Programming_Model/ACPI_Software_Programming_Model.html#generic-address-structure-gas
